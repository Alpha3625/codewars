...
## 🟢 8 kyu 
### JavaScript
- [Check same case](./8-kyu/JavaScript/check-same-case.js)

- [Flick switch](./8-kyu/JavaScript/flick-switch.js)

- [Logical calculator](./8-kyu/JavaScript/logical-calculator.js)

- [Simple calculator](./8-kyu/JavaScript/simple-calculator.js)
...
- [Switch it up!](./8-kyu/TypeScript/switch-it-up.ts)
